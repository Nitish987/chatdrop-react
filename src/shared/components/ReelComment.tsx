...
import ReelCommentController, { CommmentLike } from '../controllers/ReelCommentController';
import DropdownItem from '../ui/DropdownItem';

interface ReelCommentProps {
  index: number;
...
export default function ReelComment({ index, comment, onDelete, isSameUser }: ReelCommentProps) {
  const commentController = ReelCommentController.getInstance(comment.id);
  ...
  return (
    <>
      {
        !isDeleted &&
        <div className='reel-comment-message'>
          <div className="reel-comment-message-header">
            <img className='reel-comment-message-user-pic' src={Avatar.get(comment.user.gender, comment.user.photo)} alt="profile_pic" />
            <div className='reel-comment-message-sender-name'>
              <span>{comment.user.name}</span>
              <span>{comment.commented_on}</span>
            </div>
            <div className="reel-comment-options">
              <IconButton icon={Icons.moreHorizontal} label='comment_options' showBorder={false} />
              <div className="reel-comment-options-dropdown">
                {
          ...
          <div className='reel-comment-message-content'>
            {comment.text}
          </div>
          <div className='reel-comment-message-footer'>
            ...
            <div className="reel-comment-like-emoji">
